...
const getSingleAcademicDepartment = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academic_department_model_1.AcademicDepartment.findById(id);
    return result;
});
const updateAcademicDepartment = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academic_department_model_1.AcademicDepartment.findOneAndUpdate({ _id: id }, payload, {
        new: true
    });
    return result;
});
